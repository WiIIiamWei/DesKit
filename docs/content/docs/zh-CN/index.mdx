...
1. 阅读 [快速开始](./docs/quick-start)，跑通模板、构建和本地安装。
2. 阅读 [Manifest](./docs/manifest)，理解 DesKit 如何识别插件。
3. 阅读 [命令与视图](./docs/commands-and-views)，把用户输入变成可交互结果。
4. 如果插件需要剪贴板、网络、后台事件，再阅读 [权限](./docs/permissions) 和 [剪贴板与后台任务](./docs/clipboard-and-background)。
5. 准备发布时，按 [提交到 Marketplace](./docs/marketplace) 的流程走。

...
1. Start with [Quick Start](./docs/quick-start) and make sure the template builds.
2. Read [Manifest](./docs/manifest) to understand how DesKit discovers a plugin.
3. Read [Commands and Views](./docs/commands-and-views) to turn user input into interactive results.
4. If your plugin needs clipboard, network, or background events, read [Permissions](./docs/permissions) and [Clipboard and Background Tasks](./docs/clipboard-and-background).
5. When you are ready to publish, follow [Submit to Marketplace](./docs/marketplace).

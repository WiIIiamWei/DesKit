...
If the plugin adds dependencies, requests sensitive permissions, or introduces background behavior, state that clearly in the PR. Reviewers should not have to infer your intent from source code.
